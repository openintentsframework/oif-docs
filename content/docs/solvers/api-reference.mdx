...
- `user` (string, required): User address in ERC-7930 interoperable format (hex-encoded)
- `intent` (object, required): Cross-chain intent specification
  ...
  - `inputs` (array, required): Input assets from the user
    - `user` (string): User address in ERC-7930 format (hex-encoded)
    - `asset` (string): Asset address in ERC-7930 format (hex-encoded)
  ...
  - `outputs` (array, required): Desired output tokens and destinations
    - `receiver` (string): Receiver address in ERC-7930 format (hex-encoded)
    - `asset` (string): Asset address in ERC-7930 format (hex-encoded)
