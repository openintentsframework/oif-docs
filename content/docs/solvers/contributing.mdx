...
description: This section will help you get started with development, understand our standards, and submit contributions effectively.
---
...
For detailed instructions on setting up the local development environment with Anvil chains, deploying contracts, and configuring test tokens, see the [Quick Setup - Local Environment](./quickstart#quick-setup---local-environment) section in the Quickstart Guide.
