---
title: Solver Crates
description: This section provides in-depth documentation for each crate in the OIF Solver system. Each crate is documented with its purpose, architecture, integration patterns, and implementation guides.
---
...
1. **Overview** - What the crate does and why it exists
