...
│  - Protocol contracts (InputSettler, OutputSettler,     |
|                        The compact)                     │
└─────────────────────────────────────────────────────────┘
```
...
Here's a typical workflow showing how the pieces fit together. For detailed step-by-step instructions, see the [Local Development Workflow](#local-development-workflow) section below.
...
The following sections provide detailed technical information about the solver-demo architecture and internal workings. If you're just getting started, you can skip to the [Usage Workflows](#usage-workflows) section below.
...
The following sections provide practical, step-by-step instructions for using solver-demo in different environments.
...
- Most gas-efficient
- See [Compact Settlement example](#compact-settlement) in Local Development Workflow
...
- See [Permit2 Settlement](#permit2-settlement) and [EIP-3009 Settlement](#eip-3009-settlement) examples in Local Development Workflow
...
The following sections provide detailed technical information about how solver-demo processes requests internally. This information is useful for developers who need to understand the system's internal workings or extend its functionality.
...
- [solver-service](/docs/solvers/crates/solver-service) - Production solver service that demo interacts with
- [solver-types](/docs/solvers/crates/solver-types) - API types and data structures used in demo
- [solver-config](/docs/solvers/crates/solver-config) - Configuration format used by demo
- [solver-order](/docs/solvers/crates/solver-order) - Order structures and validation logic
- [solver-core](/docs/solvers/crates/solver-core) - Core solver engine that processes submitted intents
