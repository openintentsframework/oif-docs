---
title: How It Works
description: The OIF Solver operates through a multi-stage pipeline that handles the complete lifecycle of cross-chain intent execution. This guide explains each stage in detail.
---
...
- **Failure Handling**: The failure handling mode (refund-automatic, refund-claim, needs-new-signature)
- **Partial Fill**: Boolean indicating whether partial fills are supported
...
> **Note:** The "Failure Handling" and "Partial Fill" features are not yet supported.
...
> **Note:** Gas calculations for settlement are not yet implemented.
