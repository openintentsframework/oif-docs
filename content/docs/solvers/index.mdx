...
- **[Quickstart Guide](/docs/solvers/quickstart)**: Get up and running in minutes
- **[How It Works](/docs/solvers/how-it-works)**: Learn about the solver's execution pipeline and core concepts
- **[Configuration Guide](/docs/solvers/crates/solver-config)**: Advanced setup options and customization
