...
cargo run --bin solver-demo -- token balance
```
...
> **Note**: If you are going to use permit2, make sure you give the proper token transfer approval before testing the process.
